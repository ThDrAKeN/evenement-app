            ...
            <div>
                ...
                <Container style={{backgroundColor: "#111827", height: "70vh"}} fluid>
                    ...
                    <Row className={"mt-1 justify-content-center"}>
                        <Col xs={11} md={7}
                             style={{backgroundColor: "#1F2937", borderRadius: 10, borderTop: "4px solid #f88181"}}
                             className={"px-5 py-4"}>
                            ...
                            <p style={{
                                ...
                                color: "white",
                                marginTop: "2%"
                            }}>Site <span style={{fontSize: 13, color: "#BCC1C8"}}>(en option)</span></p>
                            <Input placeholder=""/>
                            <p style={{
                                textAlign: "left",
                                fontSize: 17,
                                ...
                                color: "white",
                                marginTop: "2%"
                            }}>Description <span style={{fontSize: 13, color: "#BCC1C8"}}>(en option)</span></p>
                            <Input.TextArea rows={3} maxLength={240}/>

                            <Row className={"mt-1"} style={{width: "auto", float: "right", marginRight: "1px"}}>
